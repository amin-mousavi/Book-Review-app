...
def book_search(request):
    ...
    if form.is_valid() and form.cleaned_data["search"]:
        ...
        if search_in == "title":
            ...
            fname_contributors = list(Contributor.objects.filter(first_names__icontains=search))
            lname_contributors = list(Contributor.objects.filter(last_names__icontains=search))
